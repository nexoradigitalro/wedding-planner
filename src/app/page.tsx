          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 items-start">
            {[
              ...
              },
              {
                ...
                features: ['1 eveniment, până la 230 invitați', 'Mese nelimitate', 'Link RSVP public', 'Import & Export CSV', 'Statistici porții & mărturii', 'Plan mese vizual', '2 colaboratori', 'Feed activitate live'],
